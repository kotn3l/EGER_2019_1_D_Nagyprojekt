				...
				<div class="container">
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="<?=site_url()?>">Kezdőlap </a>  <span class="lnr lnr-arrow-right"></span>  <a href="<?=site_url('car')?>"> Autóink</a></p>
						</div>											
					</div>
				</div>
			</section>
					...
					<div class="active-model-carusel">
						...
						<div class="row align-items-center single-model item">
							<div class="col-lg-6 model-left">
								...
								<p><?=$item['leírás']?></p>
								<p>
									Ülések és ajtók száma: <?=$item['ules']?> személy - <?=$item['ajto']?> ajtó <br>
									Hengerűrtartalom: <?=$item['hengerurtartalom']?>ccm <br>
									Meghajtás: <?=$item['meghajtas']?><br>
									Ár: <?=$item['ar']?> Ft<br>
